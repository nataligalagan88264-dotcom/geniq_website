...
Через редактор доступны общие ссылки и медиа, первый экран и услуги главной страницы, отзывы, блог, FAQ и SEO основных маршрутов. Подробная инструкция для владельца находится в [`frontend/CMS_SETUP.md`](./frontend/CMS_SETUP.md).
