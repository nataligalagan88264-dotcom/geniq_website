...
const AXES = [
  {
    code: "CORE",
    title: "Ядро личности",
    question: "Как я воспринимаю и понимаю мир?",
  ...
  },
  {
    code: "DRIVE",
    title: "Мотивация",
    question: "Что действительно включает меня?",
  ...
  },
  {
    ...
    question: "Как я превращаю потенциал в результат?",
  ...
  },
  {
    ...
    question: "Как я возвращаю энергию?",
  ...
  },
  {
    ...
    question: "Что незаметно управляет моими срывами?",
          ...
          <div className="grid lg:grid-cols-[6.5fr_5.5fr] gap-8 lg:gap-10 items-start">
            <div>
              ...
              <div className="grid sm:grid-cols-3 gap-3 mt-8">
                {["Увидеть все части", "Найти взаимосвязи", "Собрать свою карту"].map((item, index) => (
          ...
          <div className="max-w-4xl">
            ...
            <div className="space-y-4 text-body text-[15px] leading-[1.75]">
              ...
              <blockquote className="my-7 border-l-2 border-[#B79BE0] pl-5 text-white text-[20px] sm:text-[25px] leading-[1.4]">
                Совпадение с описанием ещё не означает, что это ваша природная сила.
              </blockquote>
