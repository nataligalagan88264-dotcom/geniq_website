      ...
      <div className="container-geniq relative z-10">
        <div className="grid lg:grid-cols-[minmax(0,1.35fr)_minmax(340px,0.85fr)] gap-10 lg:gap-x-16 lg:gap-y-8 items-start">
          ...
          <div className="reveal lg:col-start-1 lg:row-start-2 space-y-5 text-body text-[15px] leading-[1.72]">
            ...
            <p className="border-l border-[#B79BE0]/60 pl-5 text-[#C8ADEE] text-[18px] sm:text-[20px] leading-[1.55]">
              Если вы сейчас где-то там же — я понимаю это состояние не по чужим рассказам.
            </p>
            <p>Тогда я перестала искать мотивацию и <span className="text-[#B79BE0] font-medium">начала искать объяснение</span>. Больше трёх лет проверяла на себе десятки подходов — от более научных (КПТ, гештальт и т. п.) до нейропрофилирования и системных типологий — и оставляла только то, что реально работало. Так собралась GENIQ — на стыке новых исследований мозга и самых результативных подходов в работе с потенциалами человека.</p>
            <p>И первым, что собрала система, стала я сама. Я увидела свою конструкцию целиком и поняла, куда иду и ради чего. <span className="text-white text-[17px] sm:text-[18px] leading-[1.6]">Когда видишь систему, действуешь из спокойствия, а не наугад.</span> Оказалось, любимое дело, понедельники без тревоги и доход, который растёт естественно, — не миф, а вопрос верных настроек.</p>
          ...
          <div className="reveal lg:col-span-2 space-y-4 text-body text-[15px] leading-[1.72]">
            <p className="author-proof-highlight">За системой уже больше 700 часов консультаций и более 300 человек, прошедших диагностику, — и это только начало. Я работаю по принципу интенсива: за несколько встреч запускаю процессы, которые стояли годами, и именно это даёт клиентам явный результат.</p>
            <p>Я не обещаю миллионы завтра и нескончаемое счастье — так это не работает. Я помогаю <span className="text-[#B79BE0] text-[17px] sm:text-[18px] leading-[1.6]">собрать разрозненные факты о вас в систему, а систему в стратегию</span>: понять, кто вы по природе и на что способны, и сделать первые шаги. Эту дорогу я прошла сама и знаю изнутри.</p>
            <p className="author-reviews-transition">Поэтому вместо продаж и убеждений я просто покажу, <span className="gradient-text">что говорят обо мне и системе сами клиенты.</span> И вы решите, доверить ли мне свой запрос.</p>
          </div>
        </div>
      </div>
    </section>
